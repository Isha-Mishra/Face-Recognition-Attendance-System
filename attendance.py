...
class Attendance:
    def __init__(self,root):
        ...
        #first image
        img=Image.open(r"C:\Users\FO\Desktop\Attendance Monitering System\college_image\class.jpg")
        ...
        #second  
        img1=Image.open(r"C:\Users\FO\Desktop\Attendance Monitering System\college_image\classe.jpg")
        ...
        bg_image.place(x=0,y=200,width=1350,height=710)

        title_lbl=Label(bg_image,text="ATTENDANCE MANAGEMENT SYSTEM",font=("times new roman",35,"bold"),bg="white",fg="red")
        ...
        #labelend entry
        #attendance_id
        attendanceId_label=Label(left_inside_frame,text="AttendanceId:",font=("times new roman",11,"bold" ))
        ...
        #name
        rollLabel=Label(left_inside_frame,text="Roll:",bg="white",font=("times new roman",11,"bold" ))
        rollLabel.grid(row=0,column=2,padx=10,pady=5)

        atten_roll=ttk.Entry(left_inside_frame,width=20,font=("times new roman",11,"bold" ))
        atten_roll.grid(row=0,column=3,padx=2,pady=5)

        #date
        nameLabel=Label(left_inside_frame,text="Name:",bg="white",font=("times new roman",11,"bold" ))
        nameLabel.grid(row=1,column=0)

        atten_name=ttk.Entry(left_inside_frame,width=20,font=("times new roman",11,"bold" ))
        atten_name.grid(row=1,column=1,pady=8)

        #Dep
        depLabel=Label(left_inside_frame,text="Department:",bg="white",font=("times new roman",11,"bold" ))
        depLabel.grid(row=1,column=2)

        atten_dep=ttk.Entry(left_inside_frame,width=20,font=("times new roman",11,"bold" ))
        atten_dep.grid(row=1,column=3,pady=8)

        #time
        timeLabel=Label(left_inside_frame,text="Time:",bg="white",font=("times new roman",11,"bold" ))
        timeLabel.grid(row=2,column=0)

        atten_time=ttk.Entry(left_inside_frame,width=20,font=("times new roman",11,"bold" ))
        atten_time.grid(row=2,column=1,pady=8)

        #Date
        dateLabel=Label(left_inside_frame,text="Roll:",bg="white",font=("times new roman",11,"bold" ))
        dateLabel.grid(row=2,column=2)

        atten_date=ttk.Entry(left_inside_frame,width=20,font=("times new roman",11,"bold" ))
        ...
        BTN_frame.place(x=0,y=220,width=650,height=25)
        ...
        delete_btn=Button(BTN_frame,text="Update",width=17,font=("times new roman",11,"bold" ),bg="blue",fg="white")
        delete_btn.grid(row=0,column=2)

        reset_btn=Button(BTN_frame,text="Reset",width=17,font=("times new roman",11,"bold" ),bg="blue",fg="white")
        ...
        ,"date","attendance"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
