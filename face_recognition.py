...
class Face_Recognition:
                    def __init__(self,root):
                        ...
                        #1st image 
                        img_top=Image.open(r"C:\Users\FO\Desktop\Attendance Monitering System\college_image\face_recognize.jpg")
                        ...
                        #2nd image
                        img_bottom=Image.open(r"C:\Users\FO\Desktop\Attendance Monitering System\college_image\identification.webp")
                        img_bottom=img_bottom.resize((950,650),Image.ANTIALIAS)
                        self.photoimg_bottom=ImageTk.PhotoImage(img_bottom)

                        f_lbl=Label(self.root,image=self.photoimg_bottom)
                        f_lbl.place(x=600,y=55,width=950,height=650)
                        ...
                        b1_1.place(x=380,y=570,width=200,height=40)
                    #attendance

                    def mark_attendance(self,i,r,n,d):
                        with open("isha.csv","r+",newline="\n") as f:
                        ...
                        def draw_boundray(img,classifier,scaleFactor,minNeigbors,color,text,clf):
                            ...
                            for(x,y,w,h) in features:
                                ...
                                if confidence>77:
                                    ...
                                    cv2.putText(img,f"Roll:{r}",(x,y-60),cv2.FONT_HERSHEY_COMPLEX,0.8,(255,25,255),3)
                                    cv2.putText(img,f"Name:{n}",(x,y-30),cv2.FONT_HERSHEY_COMPLEX,0.8,(255,25,255),3)
                                    cv2.putText(img,f"Dep:{d}",(x,y-5),cv2.FONT_HERSHEY_COMPLEX,0.8,(255,25,255),3)
